...
import ru.testAssignment.voting.util.exception.ErrorInfo;
import ru.testAssignment.voting.util.exception.ErrorType;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo handleError(HttpServletRequest req, TimesUpException e) {
        return logAndGetErrorInfo(req, e, false, ErrorType.LATE_TO_VOTING);
    }
